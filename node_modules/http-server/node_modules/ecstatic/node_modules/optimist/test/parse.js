...
test('short capture', function (t) {
    t.same(
        optimist.parse([ '-h', 'http://192.168.0.103' ]),
        { h : 'http://192.168.0.103', _ : [], $0 : $0 }
    );
    t.end();
});
...
test('short captures', function (t) {
    t.same(
        optimist.parse([ '-h', 'http://192.168.0.103', '-p', '555' ]),
        { h : 'http://192.168.0.103', p : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('long captures sp', function (t) {
    t.same(
        optimist.parse([ '--host', 'http://192.168.0.103', '--port', '555' ]),
        { host : 'http://192.168.0.103', port : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('mixed short bool and capture', function (t) {
    t.same(
        optimist.parse([ '-h', 'http://192.168.0.103', '-fp', '555', 'script.js' ]),
        {
            f : true, p : 555, h : 'http://192.168.0.103',
            _ : [ 'script.js' ], $0 : $0,
        }
    );
    t.end();
